                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3 col-lg-3" align="center">
                                @if ( isset($user_info[0]->image) && $user_info[0]->image == "" )
                                    <img alt="User Pic" src="/images/pp.png" class="img-circle img-responsive">
                                @else
                                    <img src="/images/{{ $user_info[0]->image }}" class="img-circle img-responsive" alt="User Pic">
                                @endif
                            </div>
                            <div class="col-md-9 col-lg-9">
                                <table class="table table-user-information">
                                    ...
                                    <tr>
                                        <td>Address:</td>
                                        <td>{{ isset($user_info[0]->gender) ? $user_info[0]->gender : '' }}</td>
                                    </tr>
                                    <tr>
                                        <td>Phone:</td>
